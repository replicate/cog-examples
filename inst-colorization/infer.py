...
class Model(cog.Model):
    ...
    def setup(self):
        ...
        print("Set up complete! You can now use the image colorizer.")
    ...
    def run(self, input):
        ...
        try:
            self.colorize(input, output_path)
            return output_path
        finally:
            self.cleanup()
    ...
    def colorize(self, input: Path, color_output_path: Path):
        ...
        print(f"Getting bounding boxes for {len(image_list)} images")
